...
object OntologyRepository {
    private val db: List<IngredientEntry> by lazy {
        ...
        try {
            ...
            list.add(IngredientEntry("turmeric", listOf("haldi", "हल्दी"), IngredientCategory.SEASONING, null, emptyList()))
            list.add(IngredientEntry("salt", listOf("namak", "नमक"), IngredientCategory.SEASONING, null, emptyList()))
            list.add(IngredientEntry("yogurt", listOf("dahi", "दही"), IngredientCategory.BASE_INGREDIENT, null, emptyList()))
            list.add(IngredientEntry("cumin", listOf("jeera", "जीरा"), IngredientCategory.SEASONING, null, emptyList()))
            list.add(IngredientEntry("ginger", listOf("adrak", "अदरक"), IngredientCategory.SEASONING, null, emptyList()))
            list.add(IngredientEntry("garlic", listOf("lahsun", "लहसुन"), IngredientCategory.SEASONING, null, emptyList()))
            list.add(IngredientEntry("saffron", listOf("kesar", "केसर"), IngredientCategory.SEASONING, null, emptyList()))
            list.add(IngredientEntry("water", listOf("wasser"), IngredientCategory.BASE_INGREDIENT, null, emptyList()))

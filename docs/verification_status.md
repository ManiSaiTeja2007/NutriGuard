...
| **[SemanticPipeline](file:///d:/projects/Ongoing/nutriguard/app/src/main/java/com/example/core/pipeline/SemanticPipeline.kt)** | `DEPRECATED` | Legacy sequential pipeline. Retained purely for rollback and validation; bypassed under converged execution graph runtime. |
